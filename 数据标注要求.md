...
![示例图片1](https://github.com/xuyuxuan666/-/资料/示例图片1.png "示例图片1" )

上述的某个红绿灯内所有灯都需要标注
尤其注意灯熄灭(off)的情况。
![示例图片2](https://github.com/xuyuxuan666/-/资料/示例图片2.png "示例图片2" )

以人眼能看清、能分辨为标准
对于需要脑补才能看清的请不要标注,特别是箭头灯,如果看不清楚就不用标了,下图箭头灯看起来就很像圆灯。这种图片可以跳过

![示例图片3](https://github.com/xuyuxuan666/-/资料/示例图片3.png "示例图片3" )
